...
function saberPagina(){
    const parametro = window.location.hash.substring(1);
...
document.write('<div class="col-sm-4" style=" width: 33,3333%"><h3>Personajes del '+ (bajo+1) +' al '+ (alto+1) +'</h3><p><a href="personajesSW.html#'+ ((page+1)> 9 ? 9 : page+1) +'">siguientes...</a></p><p><a href="personajesSW.html#'+ ((page-1)< 0 ? 0 : page-1) +'">anteriores...</a></p></div>');   
